...
export default function PrintSalePayment() {
                    ...
                    {print.salePayments?.map((s, i) => {
                        return (
                            <tr key={i} className="border-b">
                                <td>{s.ref}</td>
                                <td className="text-center">{format(s.rest)}</td>
                                <td className="text-right">{format(s.advance)}</td>
                                <td className="text-right">{format(s.balance)}</td>
                            </tr>
                        );
                    })}
                </tbody>
