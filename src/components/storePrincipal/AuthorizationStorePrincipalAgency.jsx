...
import { getAllAgenciesStorePrincipalAuthorization } from "../../utils/http";
...
export default function AuthorizationStorePrincipalAgency() {
    ...
    const { data } = useQuery({
        queryKey: ["agenciesstoreprincipal", { id }],
        queryFn: ({ signal }) => getAllAgenciesStorePrincipalAuthorization({ signal, id }),
