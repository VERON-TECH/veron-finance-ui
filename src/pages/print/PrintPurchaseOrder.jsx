        ...
        >
            ...
            <div className="flex justify-between mb-6">
                ...
                <div className="text-right">
                    ...
                    <p><strong>N° :</strong> {print.purchaseOrder.ref}</p>
            ...
            <div className="flex justify-end">
                <div className="w-1/3">
                    <div className="flex justify-between border-b py-1">
                        <span>Prix HT :</span>
                        <span>{Number(print.purchaseOrder.price).toLocaleString()}</span>
                    </div>
                    <div className="flex justify-between border-b py-1">
                        <span>Remise :</span>
                        <span>{Number(print.purchaseOrder.discount).toLocaleString()}</span>
                    </div>
                    <div className="flex justify-between font-bold text-base py-2">
                        <span>Prix TTC :</span>
                        <span>{Number(print.purchaseOrder.priceTtc).toLocaleString()}</span>
                    </div>
                </div>
            </div>
            ...
            <div className="flex justify-between mt-16">
                <div>
                    <p className="font-bold">Signature Fournisseur</p>
